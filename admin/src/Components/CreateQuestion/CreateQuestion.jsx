    ...
    return (
        <>
            ...
            <div className="form-group">
                ...
                <textarea spellCheck="false" key={audioKey} name='question' onChange={handleChangeQuestion} value={currentQuestion?.question || ''} placeholder="Nhập nội dung câu hỏi"></textarea>
            </div>
            <div className="form-group">
