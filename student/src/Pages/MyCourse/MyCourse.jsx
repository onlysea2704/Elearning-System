...
const MyCourse = () => {
  ...
  const purchasedCourse = courses.filter(course =>
    ...
    // Lấy ra khóa học mà Student 1 mua
  );
  ...
  const filteredCourses = purchasedCourse.filter((course) =>
    selectedFilter === "all skill" ? true : course.type_course === selectedFilter
  );
        ...
        <div className="page-content">
          ...
          <div className="courses-container">
            {displayedCourses.map((course) => (
              <Card key={course.id} course={course} type="Vào Học" />
            ))}
